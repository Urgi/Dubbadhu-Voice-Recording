...
/**
 * Series list + “Add series” — same step admins see under Series Config (`LessonConfig` screen).
 */
export default function SeriesConfigListView({ navigation }: Props) {
  const { role } = useAuth()
